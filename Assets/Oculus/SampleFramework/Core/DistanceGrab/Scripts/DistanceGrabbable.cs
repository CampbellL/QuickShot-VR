...
namespace OculusSampleFramework
{
    public class DistanceGrabbable : OVRGrabbable
    {
        ...
        public override void GrabBegin(OVRGrabber hand, Collider grabPoint)
        {
            ...
            var weaponScript = GetComponent<WeaponBehaviour>();

            if (weaponScript)
            {
                weaponScript.SetGrabState(true, hand);
            }
        }
        ...
        public override void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
        {
            ...
            if (weaponScript)
            {
                weaponScript.SetGrabState(false, grabbedBy);
            }

            linearVelocity += new Vector3(0, 0, GameSettings.Instance.playerSpeed * 10);
        ...
        public void SetObjectActivation(bool isActivated)
        {
            ...
            {
                rend.enabled = isActivated;
            }

            var weaponScript = GetComponent<WeaponBehaviour>();
            if (weaponScript) weaponScript.SetWeaponActivation(isActivated);
